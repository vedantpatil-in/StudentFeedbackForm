  ...
  <body>
    ...
    <?php 
      ...
      if (isset($_SESSION['login_user'])) {
        ...
        $countResult = mysqli_query($con, "SELECT subject, COUNT(*) AS total FROM feedback GROUP BY subject");
        if ($countResult && mysqli_num_rows($countResult) > 0) {
          echo "<h2>Feedback received by subject</h2>";
          echo "<table border='1' id='subject-counts'>
                  <tr>
                    <th>Subject</th>
          ...
          while ($countRow = mysqli_fetch_assoc($countResult)) {
            echo "<tr>";
            echo "<td>" . htmlspecialchars($countRow['subject']) . "</td>";
